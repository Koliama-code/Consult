...
const LandingPage = () => {
  ...
  }, [testimonials.length]); // Add testimonials.length as dependency
  ...
  return (
    <div className="min-h-screen bg-[#1e242f]">
      <nav className="bg-[#1e242f]/80 backdrop-blur-md py-8 fixed w-full z-50 shadow-lg">
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(30, 36, 47, 0.92) 0%, rgba(30, 36, 47, 0.95) 100%)",
          }}
        />

        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-6xl md:text-8xl font-bold text-white mb-8 mt-24 leading-tight">
              L'innovation
              <br />
              au service de votre
              <br />
      ...
      <section id="features" className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center text-white mb-4">
          Tout-en-Un
          <span className="block w-24 h-2 bg-blue-500 mx-auto mt-2"></span>
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-[#2a303c] p-8 rounded-xl shadow-lg">
      ...
      <section id="about" className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mt-12">
          ...
          <div className="bg-[#2a303c] p-8 rounded-xl">
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-4">
                <h4 className="text-3xl font-bold text-blue-500 mb-2">1000+</h4>
                <p className="text-gray-400">Patients Aidés</p>
              </div>
              <div className="text-center p-4">
                <h4 className="text-3xl font-bold text-blue-500 mb-2">50+</h4>
                <p className="text-gray-400">Médecins Partenaires</p>
              </div>
              <div className="text-center p-4">
              ...
              <div className="text-center p-4">
                <h4 className="text-3xl font-bold text-blue-500 mb-2">95%</h4>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          <div className="bg-[#2a303c] p-6 rounded-xl shadow-lg">
            <div className="flex flex-col items-center">
              ...
              <div className="text-center">
                <h4 className="text-white font-semibold">Dr. Mukendi Jean</h4>
                <p className="text-blue-400">Médecin Généraliste</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#2a303c] p-6 rounded-xl shadow-lg">
            <div className="flex flex-col items-center">
              ...
              <div className="text-center">
                <h4 className="text-white font-semibold">Dr. Kalala Marie</h4>
                <p className="text-blue-400">Pédiatre</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#2a303c] p-6 rounded-xl shadow-lg">
            <div className="flex flex-col items-center">
              ...
              <div className="text-center">
                <h4 className="text-white font-semibold">Dr. Kabongo Paul</h4>
                <p className="text-blue-400">Cardiologue</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="testimonials" className="container mx-auto px-4 py-16">
        <div className="flex flex-col md:flex-row items-start justify-between gap-12">
          ...
          <div className="md:w-1/3">
            <span className="text-blue-500 uppercase font-medium mb-2 block">
              TÉMOIGNAGES
            </span>
          ...
          <div className="md:w-2/3 relative">
            <div className="bg-[#2a303c] p-8 rounded-2xl shadow-lg max-w-2xl ml-auto">
      ...
      {/* Footer */}
      <footer className="bg-[#1e242f] py-8 mt-8">
